...
/**
 * Daily activity which contains the daily view fragment
 *
...
public class DailyActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new CompleteDailyView( MainMenu.currentDate ) ).commit();
    ...
    private void setComponents() {
        ...
        hostEventButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DailyActivity.this, HostEvent.class));
            }
        });
    ...
    protected void setButtonListeners(){
        ...
        layoutGoToMonth.setOnClickListener(new View.OnClickListener() {//Go to month
            @Override
            public void onClick(View v) {
                startFeedBackAnimation( layoutGoToMonth );
                startActivity(new Intent(DailyActivity.this, MainMenu.class));
        ...
        layoutGoToWeek.setOnClickListener(new View.OnClickListener() {//Go to week
            @Override
            public void onClick(View v) {
                startFeedBackAnimation( layoutGoToWeek );
                startActivity(new Intent(DailyActivity.this, WeeklyActivity.class));
        ...
        layoutGoToDay.setOnClickListener(new View.OnClickListener() { // Go to day
            @Override
            public void onClick(View v) {
        ...
        layoutGoToFlow.setOnClickListener(new View.OnClickListener() { // go to flow
            @Override
            public void onClick(View v) {
                startFeedBackAnimation( layoutGoToFlow );
                startActivity(new Intent(DailyActivity.this, ExpandableListForFlowPage.class));
            }
        });
    }
