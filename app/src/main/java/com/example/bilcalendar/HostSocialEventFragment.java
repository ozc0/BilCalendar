...
import library.User;
/**
 * Class representing a social event fragment.
 *
 * @author Team of Ministler
 * @date 12/25/2019
 */
public class HostSocialEventFragment extends Fragment implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    private static final String TAG = "HostSocialEventFragment";

    private TextInputLayout eventName, notes, organizerName, location, quota;
    private TextView dateText, endTimeText, startTimeText;
    private LinearLayout dateLayout, startLayout, endLayout;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.host_social_event,container,false);

        eventName = view.findViewById(R.id.social_event_name_textInput);
        notes = view.findViewById(R.id.social_event_notes_textInput);
        quota = view.findViewById(R.id.social_event_quota_textInput);
        organizerName = view.findViewById(R.id.social_event_organizer_name_textInput);
        location = view.findViewById(R.id.social_event_location_name_textInput);

        dateText =  view.findViewById(R.id.social_event_date_textView);
        startTimeText = view.findViewById(R.id.social_event_start_time_textView);
        endTimeText = view.findViewById(R.id.social_event_end_time_textView);

        dateLayout = view.findViewById(R.id.social_event_date_layout);
        startLayout = view.findViewById(R.id.social_event_start_time_layout);
        endLayout = view.findViewById(R.id.social_event_end_time_layout);
        ...
        hostEventButton = view.findViewById(R.id.host_social_event_button);
        hostEventButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if( isAppropriate() ) {
                    ...
                    databaseManager.addSocialEvent( eventName.getEditText().getText().toString(), notes.getEditText().getText().toString(), user.getId(), eventDay, startHour, startMinute, endHour, endMinute, location.getEditText().getText().toString(), quotaInt );
    ...
    private void setLayoutListeners() {
        ...
        dateLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setTargetFragment(HostSocialEventFragment.this, 0);
    ...
    private boolean isAppropriate() {
        ...
        if( organizerName.getEditText().getText().length() == 0 ) {
            Toast.makeText(context, "Organizer name cannot be empty!", Toast.LENGTH_SHORT).show();
            return false;
        }

        if( location.getEditText().getText().length() == 0 ) {
            Toast.makeText(context, "Location description cannot be empty!", Toast.LENGTH_SHORT).show();
            return false;
        }
